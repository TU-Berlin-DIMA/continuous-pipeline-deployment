...
Although SGD is typically used to train models on static datasets, our proposed system uses it to both perform incremental and batch updates to the deployed model.
...
This makes our system applicable to a large range of machine learning models beyond the ones demonstrated in our evaluation.
...
\todo[inline]{the other experiments}
