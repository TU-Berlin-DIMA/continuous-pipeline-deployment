...
\todo[inline]{rename the model names (baseline, baseline+ and velox)}
\todo[inline]{Use case: New data sources while the system is running}
\todo[inline]{Separate system design from model description}
\todo[inline]{Include a meta graph (performance + quality)}
\todo[inline]{Check the gray background in printed version}
% Problem
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{../images/use-case-1.png}
...
\begin{figure*}[!t]
\centering
\includegraphics[scale = 0.5]{../images/velox-1.png}
...
\begin{figure*}[t]
\centering
\includegraphics[scale = 0.5]{../images/continuous-1.png}
