...
\subsection{Incomplete - Experiments in the Distributed Environment}
...
\subsection{Incomplete - Discussion}
...
\ref{subfig:cover-type-meta}--\ref{subfig:adult-meta} shows the trade off between quality and total training time for our local classification datasets.
