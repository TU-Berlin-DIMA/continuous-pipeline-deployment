...
\todo[inline]{These two figures are just to show that these parameters dont always have the same effect .. should I include them? }
\begin{figure}[h]
\begin{subfigure}{\columnwidth}
\centering
...
\subsection{Experiments in Local Environment}\label{subsec:experiment-local}
...
\ref{subfig:url-meta}--\ref{subfig:susy-meta} \todo[inline]{finish after the experiments are done}
