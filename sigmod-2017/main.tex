...
To demonstrate, we perform the same set of experiments on the \textit{MNIST} dataset.
...
New training observations that exist in the buffer have the maximum effect on the model's quality, since they have not been yet examined by the model.
...
Setting these parameters to small values however will decrease the running time considerably and save computation resources.
