...
\todo[inline]{replace runtime experiments of sampling rate and buffer size with average time of single iteration ??}
\todo[inline]{Offline only: train on data on disk and use the model without incremental learning}
\todo[inline]{rename velox to full retraining in figures}
