...
Especially, when considering the effect the buffer size has on the running time.
...
Similar to \textit{movie-lens-100k}, continuous method has the lowest error rate among all the implemented methods.
