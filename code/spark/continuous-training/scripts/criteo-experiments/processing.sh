...
data.repartition(1440).saveAsTextFile("hdfs://cloud-11:44000/user/behrouz/criteo/experiments/stream/day_1/")

val data = sc.textFile("hdfs://cloud-11:44000/criteo/day_2")
data.repartition(1440).saveAsTextFile("hdfs://cloud-11:44000/user/behrouz/criteo/experiments/stream/day_2/")

val data = sc.textFile("hdfs://cloud-11:44000/criteo/day_3")
data.repartition(1440).saveAsTextFile("hdfs://cloud-11:44000/user/behrouz/criteo/experiments/stream/day_3/")

val data = sc.textFile("hdfs://cloud-11:44000/criteo/day_4")
data.repartition(1440).saveAsTextFile("hdfs://cloud-11:44000/user/behrouz/criteo/experiments/stream/day_4/")

val data = sc.textFile("hdfs://cloud-11:44000/criteo/day_5")
data.repartition(1440).saveAsTextFile("hdfs://cloud-11:44000/user/behrouz/criteo/experiments/stream/day_5/")
