...
# Plot Criteo full
continuous = read.csv('criteo-full/continuous/model-type-lr/num-iterations-500/slack-10/offline-step-1.0/online-step-1.0/continuous-step-1.0/2017-07-20-19-42/confusion-matrix.txt', header = FALSE, col.names = c('tp','fp','tn','fn','accuracy','precision','recall','fMeasure'))

#velox = read.csv('criteo-full/continuous/model-type-lr/num-iterations-500/slack-10/offline-step-1.0/online-step-1.0/continuous-step-1.0/2017-07-20-09-09/confusion-matrix.txt', header = FALSE, col.names = 'velox')

#baselinePlus = read.csv('criteo-full/continuous/model-type-lr/num-iterations-500/slack-10/offline-step-1.0/online-step-1.0/continuous-step-1.0/2017-07-20-09-09/confusion-matrix.txt', header = FALSE, col.names = 'baseline-plus')

#baseline= read.csv('criteo-full/continuous/model-type-lr/num-iterations-500/slack-10/offline-step-1.0/online-step-1.0/continuous-step-1.0/2017-07-20-09-09/confusion-matrix.txt', header = FALSE, col.names = 'baseline')
...
df = data.frame(time = 1:nrow(continuous),continuous)

ggplot(data = df, aes(x = time, y = accuracy)) + 
  geom_line() + 
