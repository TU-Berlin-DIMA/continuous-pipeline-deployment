...
\todo[inline]{Should I rename platform to framework everywhere in the paper? In the rest of the paper we are referring to our work (and periodical and online) as 'platforms'}
\begin{itemize}
