...
On the other hand, the continuous deployment approach guarantees high-quality models with only a linear increase in the cumulative deployment cost (the training time for every proactive training is constant) which results in a slow increase in the value of $PI$ over time. 
