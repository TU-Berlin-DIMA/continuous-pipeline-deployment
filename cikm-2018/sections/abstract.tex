...
We show that the continuous deployment reduces the total training cost up to 13 times while providing the same level of quality when compared to the state-of-the-art deployment approaches.
\end{abstract}