...
As a result, the continuous deployment improves the error rate by 0.3\%  and reduces the total training cost 13 times over the state-of-the-art deployment approaches.
\end{abstract}