...
\todo{Theoretical bound on the quality?}
...
In Section \ref{sec:system-architecture}, we introduce the design principles and architecture of our deployment system.
In Section \ref{evaluation}, we evaluate our continuous training approach and compare the performance of our platform with other model deployment approaches.
