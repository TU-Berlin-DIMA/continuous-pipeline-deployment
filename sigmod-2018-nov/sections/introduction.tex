...
\end{itemize}
Once the pipeline is created, the deployment platform serves the model and prepares it for receiving prediction queries \textcircled{2}.
...
\textit{Online Statistics Computation \hl{and Data Materialization}} 
