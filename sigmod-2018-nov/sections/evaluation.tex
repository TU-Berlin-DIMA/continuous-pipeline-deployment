...
\todo[inline]{should we have another pipeline as well?}
...
Day 1 to Day 5 are used as a streaming dataset and Day 6 is used for evaluating the model.
...
Proactive training is an extension of SGD, therefore the process of tuning the learning rate adaptation method is no different from tuning the it for offline training.
Figure \ref{fig:criteo-learning-rate} shows the effect of choosing different learning rate adaptation technique on the Criteo pipeline.
