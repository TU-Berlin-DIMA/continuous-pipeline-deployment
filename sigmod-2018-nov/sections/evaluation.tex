...
\centering
\includegraphics[width=\columnwidth]{../images/experiment-results/training-time-deployment-types-experiment.eps}
\caption{Deployment Approaches}
\label{fig:training-time-deployment}
\end{subfigure}
\begin{subfigure}{\columnwidth}
\centering
\includegraphics[width=\columnwidth]{../images/experiment-results/training-time-optimizations-experiment.eps}
