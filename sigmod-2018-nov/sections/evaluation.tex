...
Figure \ref{fig:scheduling-policy-time}  shows the scheduling intervals, computed based on the above variables, for every execution of the proactive training.
