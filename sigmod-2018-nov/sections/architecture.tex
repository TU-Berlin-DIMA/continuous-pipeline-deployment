...
To increase the performance of the sampling operation, we utilize data partitioning and multi-stage sampling.
...
When time-based sampling technique is used to create a sample of the historical data, the data manager uses a multi-stage sampling technique to speed up the sampling process.
...
Then, in the first stage of the sampling, a sample of the data partitions are created.
In the second stage of the sampling, the partitions are accessed directly, and from each partition, a sample of the data is created.
The samples from each partition are combined to assemble the final sample.
This sample is then passed to the pipeline manager and used for the next proactive training.
In the experiment section, we analyze the performance of the data partitioning and multi-stage sampling.
