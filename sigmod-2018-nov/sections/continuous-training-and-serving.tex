...
In our prototype, we implemented a standard scaler, a missing value computer, and a one-hot encoder.
The above components require the mean, the standard deviation, and for the one-hot encoder, a hash table of the unique categorical parameters in every feature column.
