% Created by tikzDevice version 0.11 on 2018-05-06 09:20:02
...
\path[draw=drawColor,line width= 0.3pt,line join=round] (186.67, 30.64) --
	(289.08, 30.64);

\path[draw=drawColor,line width= 0.3pt,line join=round] (186.67, 53.16) --
	(289.08, 53.16);

\path[draw=drawColor,line width= 0.3pt,line join=round] (186.67, 75.67) --
	(289.08, 75.67);

\path[draw=drawColor,line width= 0.3pt,line join=round] (186.67, 98.18) --
	(289.08, 98.18);

\path[draw=drawColor,line width= 0.3pt,line join=round] (186.67,120.70) --
	(289.08,120.70);
\definecolor{drawColor}{RGB}{190,190,190}
...
\path[draw=drawColor,line width= 0.6pt,dash pattern=on 1pt off 3pt ,line join=round] (186.67, 41.90) --
	(289.08, 41.90);

\path[draw=drawColor,line width= 0.6pt,dash pattern=on 1pt off 3pt ,line join=round] (186.67, 64.41) --
	(289.08, 64.41);

\path[draw=drawColor,line width= 0.6pt,dash pattern=on 1pt off 3pt ,line join=round] (186.67, 86.93) --
	(289.08, 86.93);

\path[draw=drawColor,line width= 0.6pt,dash pattern=on 1pt off 3pt ,line join=round] (186.67,109.44) --
	(289.08,109.44);
\definecolor{drawColor}{RGB}{255,255,255}
...
\path[draw=drawColor,line width= 1.1pt,line join=round,fill=fillColor] (191.32, 19.38) rectangle (237.87, 95.78);
\definecolor{drawColor}{RGB}{0,191,196}
\definecolor{fillColor}{RGB}{0,191,196}
...
\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  1.60] at (177.67, 36.39) {100};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  1.60] at (177.67, 58.90) {200};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  1.60] at (177.67, 81.42) {300};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  1.60] at (177.67,103.93) {400};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (433.62,144.54);
\definecolor{drawColor}{RGB}{0,0,0}
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (181.67, 41.90) --
	(186.67, 41.90);

\path[draw=drawColor,line width= 0.6pt,line join=round] (181.67, 64.41) --
	(186.67, 64.41);

\path[draw=drawColor,line width= 0.6pt,line join=round] (181.67, 86.93) --
	(186.67, 86.93);

\path[draw=drawColor,line width= 0.6pt,line join=round] (181.67,109.44) --
	(186.67,109.44);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (433.62,144.54);
