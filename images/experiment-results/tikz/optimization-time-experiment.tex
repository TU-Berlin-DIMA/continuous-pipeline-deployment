% Created by tikzDevice version 0.11 on 2018-05-17 12:41:29
...
\path[draw=drawColor,line width= 0.3pt,line join=round] (186.67, 31.34) --
	(289.08, 31.34);

\path[draw=drawColor,line width= 0.3pt,line join=round] (186.67, 55.27) --
	(289.08, 55.27);

\path[draw=drawColor,line width= 0.3pt,line join=round] (186.67, 79.19) --
	(289.08, 79.19);

\path[draw=drawColor,line width= 0.3pt,line join=round] (186.67,103.11) --
	(289.08,103.11);
\definecolor{drawColor}{RGB}{190,190,190}
...
\path[draw=drawColor,line width= 0.6pt,dash pattern=on 1pt off 3pt ,line join=round] (186.67, 43.31) --
	(289.08, 43.31);

\path[draw=drawColor,line width= 0.6pt,dash pattern=on 1pt off 3pt ,line join=round] (186.67, 67.23) --
	(289.08, 67.23);

\path[draw=drawColor,line width= 0.6pt,dash pattern=on 1pt off 3pt ,line join=round] (186.67, 91.15) --
	(289.08, 91.15);

\path[draw=drawColor,line width= 0.6pt,dash pattern=on 1pt off 3pt ,line join=round] (186.67,115.08) --
	(289.08,115.08);
\definecolor{drawColor}{RGB}{255,255,255}
...
\path[draw=drawColor,line width= 1.1pt,line join=round,fill=fillColor] (191.32, 19.38) rectangle (237.87, 61.49);
\definecolor{drawColor}{RGB}{0,191,196}
\definecolor{fillColor}{RGB}{0,191,196}
...
\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  1.60] at (177.67, 37.80) {200};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  1.60] at (177.67, 61.72) {400};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  1.60] at (177.67, 85.64) {600};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  1.60] at (177.67,109.57) {800};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (433.62,144.54);
\definecolor{drawColor}{RGB}{0,0,0}
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (181.67, 43.31) --
	(186.67, 43.31);

\path[draw=drawColor,line width= 0.6pt,line join=round] (181.67, 67.23) --
	(186.67, 67.23);

\path[draw=drawColor,line width= 0.6pt,line join=round] (181.67, 91.15) --
	(186.67, 91.15);

\path[draw=drawColor,line width= 0.6pt,line join=round] (181.67,115.08) --
	(186.67,115.08);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (433.62,144.54);
