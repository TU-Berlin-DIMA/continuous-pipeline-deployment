...
\todo[inline]{This Figure can be removed}
\begin{figure}[t]
\centering
...
By removing the above assumption, proactive training can be scheduled to execute more frequently.}\todo[inline]{Rework or remove}
...
When time-based sampling technique is used, \hl{the data manager uses samples the partitions instead of the individual data points.}\todo[inline]{Rework the sentence}
...
The scheduler uses these parameters to schedule a new proactive training.} \todo[inline]{This paragraph is more relevant to Evaluation Section}
