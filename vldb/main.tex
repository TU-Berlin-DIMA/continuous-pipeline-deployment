...
When a machine learning model is trained, it is deployed into a system where it can answer prediction queries in a real-time and reliable fashion.
...
Our experiments show that our deployment method updates models two to five times faster than the current deployment methods, without degrading, and in some cases even increasing the quality of the model.
\end{abstract}
