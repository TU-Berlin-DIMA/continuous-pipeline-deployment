...
\todo[inline]{BD: Is this sentence clear? What I mean to say is that since we the items are arriving one at a time, both sampling and scheduling rate can be set to exact values. Because of Spark's mini batch, the scheduling and sampling are approximates rather than exact values}
